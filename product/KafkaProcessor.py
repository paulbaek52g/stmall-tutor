...
from PolicyHandler import wheneverDeliveryCompleted_StockDecrease
from PolicyHandler import wheneverDeliveryReturned_StockIncrease
...
def consume(msg):
    ...
    if data['eventType'] == "DeliveryCompleted":
        wheneverDeliveryCompleted_StockDecrease(data)
    if data['eventType'] == "DeliveryReturned":
        wheneverDeliveryReturned_StockIncrease(data)
